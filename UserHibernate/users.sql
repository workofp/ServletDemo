...
CREATE TABLE `user_role` (
  ...
  PRIMARY KEY  (`USER_ROLE_USER_ID`,`USER_ROLE_ID`),
...
ADD CONSTRAINT `FK143BF46A6ECCD0F` FOREIGN KEY (`USER_ROLE_ROLE_ID`) REFERENCES `role` (`ROLE_ID`),
ADD CONSTRAINT `FK143BF46AAC1790EF` FOREIGN KEY (`USER_ROLE_USER_ID`) REFERENCES `user` (`USER_ID`);
